...
module.exports = {
  mongodb: {
    ...
    adminUsername: getFileEnv(adminUsername) || 'walgreen',
    adminPassword: getFileEnv(adminPassword) || '5101',
  ...
  site: {
    ...
    host: process.env.VCAP_APP_HOST || '192.168.0.31',
  ...
  basicAuth: {
    username: getFileEnv(basicAuthUsername) || 'wal',
    password: getFileEnv(basicAuthPassword) || '0101',
  },
